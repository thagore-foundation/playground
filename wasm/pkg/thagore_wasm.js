/* @ts-self-types="./thagore_wasm.d.ts" */
...
export class CompileResult {
    ...
    get output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.compileresult_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get success() {
        const ret = wasm.__wbg_get_compileresult_success(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * `true` when compilation and execution succeeded.
     ...
     */
    set success(arg0) {
        wasm.__wbg_set_compileresult_success(this.__wbg_ptr, arg0);
    }
}
 ...
 * @returns {string}
 */
export function check_only(source) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.check_only(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('thagore_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
